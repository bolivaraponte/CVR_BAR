    ...
    if el.t == "Para" or el.t == "Plain" then
        for k, _ in ipairs(el.content) do
            ...
            if el.content[k].t == "Str" and el.content[k].text == "Aponte," and
                ...
                el.content[k + 2].t == "Space" and el.content[k + 3].t == "Str" and
                el.content[k + 3].text:find("^B.") then

                local _, e = el.content[k + 3].text:find("^B.")
                local rest = el.content[k + 3].text:sub(e + 1) -- empty if e+1>length
