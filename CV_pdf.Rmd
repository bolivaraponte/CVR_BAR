...
#linkedin: 
aboutme: I am curiosity driven community ecologist focused on plant-fungal symbiosis and genomics.
skills: R (proficient), Bash (intermmediate), Python (beginner)
...
output:
  vitae::awesomecv:
    ...
    fig_caption: yes
    keep_tex: yes
    pandoc_args: ["--lua-filter=lua/strong_sur.lua"]
